...
mod test_utils {
    ...
    use crate::{decoder::SftpDecoder, encoder::SftpEncoder, Attrs, Error, Owner, Time};
        ...
        T: Serialize + DeserializeOwned + PartialEq + Debug,
    {
        ...
        let output = T::deserialize(&mut deserializer).unwrap_or_else(|err| {
            panic!("Deserialization of {:?} should succeed: {:?}", encoded, err)
        });
    ...
    pub(crate) const ATTRS_VALID: [(Attrs, &[u8]); 20] = [
            ...
            (
                Attrs {
                    perms: Some(0xfeba7632),
                    ..Attrs::new()
                },
                b"\0\0\0\x04\xfe\xba\x76\x32",
            ),
            // time
            (
                Attrs {
            ...
            (
                ...
                b"\0\0\0\x05\xfe\xdc\xba\x98\x76\x54\x32\x10\xfe\xba\x76\x32",
            ),
            // size + time
            (
                Attrs {
            ...
            (
                ...
                b"\0\0\0\x06\xf7\xe6\xd5\xc4\xb3\xa2\x91\x80\xfe\xba\x76\x32" ,
            ),
            // owner + time
            (
                Attrs {
            ...
            (
                ...
                b"\0\0\0\x0c\xfe\xba\x76\x32\xfd\xb9\x75\x31\xec\xa8\x64\x20",
            ),
            // size + owner + perms
            (
                Attrs {
                ...
                b"\0\0\0\x07\xfe\xdc\xba\x98\x76\x54\x32\x10\xf7\xe6\xd5\xc4\xb3\xa2\x91\x80\xfe\xba\x76\x32"
                    ,
            ),
            // size + owner + time
            (
            ...
            (
                ...
                b"\0\0\0\x0d\xfe\xdc\xba\x98\x76\x54\x32\x10\xfe\xba\x76\x32\xfd\xb9\x75\x31\xec\xa8\x64\x20",
            ),
            // owner + perms + time
            (
                Attrs {
                ...
                b"\0\0\0\x0e\xf7\xe6\xd5\xc4\xb3\xa2\x91\x80\xfe\xba\x76\x32\xfd\xb9\x75\x31\xec\xa8\x64\x20",
            ),
            ...
            (
                ...
                b"\0\0\0\x0f\xfe\xdc\xba\x98\x76\x54\x32\x10\xf7\xe6\xd5\xc4\xb3\xa2\x91\x80\xfe\xba\x76\x32\xfd\xb9\x75\x31\xec\xa8\x64\x20",
            ),
        ];
}
